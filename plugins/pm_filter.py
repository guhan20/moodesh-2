...
from pyrogram.types import InlineKeyboardMarkup, WebAppInfo, InlineKeyboardButton, CallbackQuery, InputMediaPhoto,InputMediaDocument,InputMediaVideo,InputMediaAnimation,InputMediaAudio
