...
#    SPELL_CHECK[msg.message_id] = movielist
        buttons = [[InlineKeyboardButton("🔍 ɢᴏᴏɢʟᴇ 🔎", url=f'https://google.com/search?q={query.replace(" ","+")}'), InlineKeyboardButton("🔍 ʏᴀɴᴅᴇx 🔎", url=f'https://yandex.com/search/?text={query.replace(" ","+")}')]]
