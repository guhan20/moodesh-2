...
<b>⏱ | {runtime} Min |
Release info : <a href={url}/releaseinfo>{release_date}</a></b>
<b>♻️ Genre : {genres}
🔊 Language : {languages}
🌎 Country of Origin : {countries}</b>
➤ Story Line: <code>{plot}</code>
<i>★ ᴘᴏᴡᴇʀᴇᴅ ʙʏ  <a href="https://t.me/Cinimaadholokam">ᴄɪɴɪᴍᴀᴀᴅʜᴏʟᴏᴋᴀᴍ</a></i></b>""")

 #/////////////////////////////////////////////////////////////////////////////////////////////////////  
    
    
IMDB_TEMPLATE_2 = environ.get("IMDB_TEMPLATE_2", """<b>🪁 Tɪᴛɪʟᴇ : <a href={url}>{title}</a></b> 
...
RP_CHANNEL = int(environ.get('RP_CHANNEL', ""))
